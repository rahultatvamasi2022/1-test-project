...
const Footer = () => {
  return (
    <div className="relative w-full h-96 bg-headerBackground text-white text-md font-medium">
      <div className="absolute -right-36 bottom-64 w-64 h-64 bg-buttonBackground rotate-[58deg] rounded-[46px]"></div>
      <footer className="relative overflow-hidden w-full h-full pt-8 pb-16 px-72 ">
        <section className="relative w-full h-full flex py-10">
          <div className="w-72 flex flex-col justify-end">
            <p className="pb-7">
              We provide a 100% online experience that allows you to receive and
              compare multiple solar quotes first.
            </p>
            <div className=" flex">
              <FacebookRoundedIcon
        ...
        <section className="relative w-full border border-secondaryBorder" />
        <div className="absolute z-10  w-[177px] h-[177px] bg-buttonBackground rounded-full -bottom-20 -left-14"></div>
      </footer>
    </div>
  );
};
